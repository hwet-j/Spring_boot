...
import com.coding.project.global.oauth.OAuthApiClient;
...
/*
Naver Developer - '로그인 API 명세', '회원 프로필 조회 API 명세' 참고
RestTemplate을 활용해서 외부 요청 후 미리 정의해둔 KakaoTokens, KakaoInfoResponse로 응답값을 받음
*/
@Component
